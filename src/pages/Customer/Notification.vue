...
export default {
  data() {
    return {
      tableData: [
        { prod_name: 'Chicken', category: 'Category 1', price: 10.99, quantity: 50, image: 'image1.jpg', status: 'pending'},
        { prod_name: 'Chicken2', category: 'Alive', price: 10.99, quantity: 4, image: 'image2.jpg', status: 'approved '},
